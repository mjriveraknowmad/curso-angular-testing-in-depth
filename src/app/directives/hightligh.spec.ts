...
// Component de prueba que utiliza la directiva HighlightDirective para probar su comportamiento en un entorno real.
@Component({
...
describe('HighlightDirective', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TestHostComponent] // Importar el componente de prueba que utiliza la directiva HighlightDirective
    }).compileComponents();

    fixture = TestBed.createComponent(TestHostComponent); // Crear una instancia del componente de prueba, del que partirán las pruebas.
